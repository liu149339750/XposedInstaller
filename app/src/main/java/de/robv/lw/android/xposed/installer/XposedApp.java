...
import de.robv.lw.android.xposed.installer.util.AssetUtil;
...
import de.robv.lw.android.xposed.installer.util.InstallZipUtil.XposedProp;
import de.robv.lw.android.xposed.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/de.robv.lw.android.xposed.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/de.robv.lw.android.xposed.installer/" : BASE_DIR_LEGACY;
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "de.robv.lw.android.xposed.installer.fileprovider", new File(info.localFilename));
